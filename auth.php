<?php
/**
 * auth.php — shared authentication gate.
 *
 * Include at the very top of any page that requires a login.
 * One session covers all protected pages (index + gallery).
 *
 * To change the password:
 *   php -r "echo password_hash('your-password', PASSWORD_BCRYPT, ['cost'=>12]);"
 * Replace APP_PASSWORD_HASH with the output.
 */
...
if (session_status() === PHP_SESSION_NONE) {
    ...
    session_set_cookie_params([
        ...
        'path'     => '/',
        'secure'   => $isHttps,   // true on HTTPS, false on HTTP
...
if (!empty($_SESSION['app_auth'])) {
    return; // caller continues normally
}
